...
from . import urls
from .cards_async import AsyncCard
from .enums import HTTPMethod, TxnType
from .request import OttuPYResponse
from .request_async import AsyncRequestResponseHandler
...
class OttuAsync:
    ...
    async def send_request(
        ...
        **request_params,
        ...
        handler = self.request_response_handler(
    ...
    def get_payment_methods(
        ...
        return (
            await self._get_payment_methods(
                plugin=plugin,
